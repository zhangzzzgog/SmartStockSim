...
import com.stock.annotation.AutoFill;
import com.stock.constant.AutoFillConstant;
import com.stock.context.BaseContext;
import com.stock.enumeration.OperationType;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.stock.mapper.*.*(..)) && @annotation(com.stock.annotation.AutoFill))")
